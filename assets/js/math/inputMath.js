/* 
 * Allows performing simple arithmetic operations 
 * including nested sub-operations) in input fields 
 * by prefixing them with the '=' sign. 
 * For example, =2+2, =10*(2-5), etc. 
 * Default behavior is to evaluate upon blur event.
 */
