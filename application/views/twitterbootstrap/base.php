...
<section id="colors">
  <div class="page-header">
    <h1>Colors <small>All the colors that are used in this Bootstrap</small></h1>
  </div>
  <div class="row">
    <div class="span12">
		<div class="row">
			<div class="span2 bg-black txt-white">black</div>
			<div class="span2 bg-graydarker txt-white">graydarker</div>
			<div class="span2 bg-graydark txt-white">graydark</div>
			<div class="span2 bg-gray txt-white">gray</div>
			<div class="span2 bg-graylight">graylight</div>
			<div class="span2 bg-graylighter">graylighter</div>
		</div>
		<div class="row">
			<div class="span2 bg-blue txt-white">blue</div>
			<div class="span2 bg-bluedark txt-white">bluedark</div>
			<div class="span2 bg-green txt-white">green</div>
			<div class="span2 bg-greendark txt-white">greendark</div>
			<div class="span2 bg-red txt-white">red</div>
			<div class="span2 bg-yellow">yellow</div>
		</div>
		<div class="row">
			<div class="span2 bg-orange txt-white">orange</div>
			<div class="span2 bg-pink txt-white">pink</div>
			<div class="span2 bg-purple txt-white">purple</div>
			<div class="span2 bg-fuschia txt-white">fuschia</div>
			<div class="span2 bg-lila txt-white">lila</div>
			<div class="span2 bg-white">white</div>
		</div>
	</div>
  </div>
</section>
