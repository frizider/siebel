...
else 
{
	...
	echo $this->bootstrap->heading(1, $this->siebel->getLang('holidays'), $customerName. ' | '. $customernumber, '<a class="backbutton" title="Go back" href="'.site_url('contacts/').'"><span><i class="icon-chevron-left"></i></span></a> '); 
?>
	<div class="row">
