...
$customername = (isset($customernumber) && !empty($customernumber)) ? utf8_encode(trim($this->siebel->getCustomerdata($customernumber, param('param_asw_database_column_customername')))) : '';	
...
$backbutton = (isset($customernumber) && !empty($customernumber)) ? ($module == 'dashboard' || $module == 'auth' || empty($module))? FALSE : '<a class="backbutton" title="Go back" href="' . site_url('dashboard/customer/' . $customernumber) . '"><span><i class="icon-chevron-left"></i></span></a> ' : FALSE;
