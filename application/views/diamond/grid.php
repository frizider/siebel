<div id="page" class="container">
	...
	<header id="overview">
		<h1>Grid</h1>
		<p class="lead">Diamond is built on a responsive 12-column grid. We've also included fixed- and fluid-width layouts based on that system.</p>
		<div class="subnav">
	...
	<section id="global">
		...
		<div class="row">
			<div class="span4">
				...
				<p>Diamond makes use of HTML elements and CSS properties that require the use of the HTML5 doctype. Be sure to include it at the beginning of every Diamondnated page in your project.</p>
...
&lt;html&gt; ... &lt;/html&gt;</pre>
	...
	<section id="gridSystem">
		...
		<div class="row">
			<div class="span4">
				<p>The default grid system provided as part of Diamond is a <strong>940px-wide, 12-column grid</strong>.</p>
			</div>
			<div class="span4">
...
&lt;/div&gt;</pre>
		...
		<div class="row">
			<div class="span4">
				<p>With the static (non-fluid) grid system in Diamond, nesting is easy. To nest your content, just add a new <code>.row</code> and set of <code>.span*</code> columns within an existing <code>.span*</code> column.</p>
...
&lt;/div&gt;</pre>
	...
	<section id="fluidGridSystem">
		...
		<div class="row">
			<div class="span4">
				<p>The easiest way to make the template fluid is by adding the class <code>.fluid</code> to the body tag of your page.</p>
				<p>Below you van see some examples and more advanced methods.</p>
	...
	<section id="gridCustomization">
		...
		<div class="row">
			<div class="span4">
				...
				<p>Built into Diamond are a handful of variables for customizing the default 940px grid system, documented above. All variables for the grid are stored in variables.less.</p>

				<h3>How to customize</h3>
				<p>Modifying the grid means changing the three <code>@grid*</code> variables and recompiling Diamond. Change the grid variables in variables.less and use one of the <a href="less.html#compiling">four ways documented to recompile</a>. If you're adding more columns, be sure to add the CSS for those in grid.less.</p>

				<h3>Staying responsive</h3>
				<p>Customization of the grid only works at the default level, the 940px grid. To maintain the responsive aspects of Diamond, you'll also have to customize the grids in responsive.less.</p>
			</div>
			<div class="span8">
	...
	<section id="responsive">
		...
		<div class="row">
			...
			<div class="span8">
				...
				<p>Diamond supports a handful of media queries in a single file to help make your projects more appropriate on different devices and screen resolutions. Here's what's included:</p>
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th>Label</th>
...
&lt;meta name="viewport" content="width=device-width, initial-scale=1.0"&gt;</pre>
		...
		<div class="row">
			<div class="span4">
				<p>Diamond doesn't automatically include these media queries, but understanding and adding them is very easy and requires minimal setup. You have a few options for including the responsive features of Diamond:</p>
				<ol>
					<li>Add @import "responsive.less" and recompile Diamond</li>
		...
		<div class="row">
			<div class="span12">
				<div class="alert alert-block">
					...
					<p>Never use these classes to hide content the you think that is less needed on an mobile device! A good design shows the same content on each divice!</p>
				</div>
			</div>
		</div>
		<div class="row">
