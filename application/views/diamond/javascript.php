<div id="page" class="container">
	...
	================================================== -->
	<header id="overview">
		<h1>Javascript for Diamond</h1>
		<p class="lead">Bring Diamond's components to life&mdash;now with 12 custom <a href="http://jquery.com/" target="_blank">jQuery</a> plugins.
		<div class="subnav">
			<ul class="nav nav-pills">
				...
				<li><a href="#introjs">Intro</a></li>
			</ul>
		</div>
	</header>


	<!-- Using Javascript w/ Diamond
	================================================== -->
	<section id="javascript">
		<div class="page-header">
			<h1>jQuery plugins <small>A dozen Diamond plugins to get you started</small></h1>
		</div>
		<div class="row">
			<div class="span3">
				<label>
			...
			<div class="span3">
				<label>
					...
					<p>Add dropdown menus to nearly anything in Diamond with this simple plugin. Diamond features full dropdown menu support on in the navbar, tabs, and pills.</p>
				</label>
			</div>
			<div class="span3">
				<label>
...
&lt;/div&gt;
				...
				<div class="alert alert-info">
					<strong>Heads up!</strong> If you want your modal to animate in and out, just add a <code>.fade</code> class to the <code>.modal</code> element (refer to the demo to see this in action) and include Diamond-transition.js.
				</div>
				<h3>Methods</h3>
				<h4>.modal(options)</h4>
...
$('#myModal').modal({
  keyboard: false
				...
				<h3>Events</h3>
				<p>Diamond's modal class exposes a few events for hooking into modal functionality.</p>
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
	...
	<section id="dropdowns">
		...
		<div class="row">
			...
			<div class="span9 columns">
				...
				<h3>Markup</h3>
				<p>To quickly add dropdown functionality to any element just add <code>data-toggle="dropdown"</code> and any valid Diamond dropdown will automatically be activated.</p>
				<div class="alert alert-info">
	...
	<section id="alerts">
		...
		<div class="row">
			...
			<div class="span9 columns">
				...
				<h3>Events</h3>
				<p>Diamond's alert class exposes a few events for hooking into alert functionality.</p>
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th style="width: 150px;">Event</th>
...
$('#myCollapsible').collapse({
  toggle: false
				...
				<h3>Events</h3>
				<p>
					Diamond's collapse class exposes a few events for hooking into collapse functionality.
				</p>
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
...
$('.carousel').carousel({
  interval: 2000
				...
				<h3>Events</h3>
				<p>Diamond's carousel class exposes two events for hooking into carousel functionality.</p>
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th style="width: 150px;">Event</th>
...
&lt;input type="text" data-provide="typeahead"&gt;
	...
	<section id="introjs">
		<div class="page-header">
			<h1 data-step="1" data-intro="Hello all! :) This project's called Intro.js.">Intro.js <small>Tutorial like tours</small></h1>
		</div>
		<div class="row">
			<div class="span4">
				<p>Better introductions for websites and features with a step-by-step guide for your projects. Thanks to <a href="http://usablica.github.io/intro.js/">Intro.js</a>.</p>
			</div>
			<div class="span8">
				<div class="example">
					<a class="btn btn-large btn-primary" href="javascript:void(0);" onclick="javascript:introJs().start();">Show me how</a>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="span4">
				<div data-step="2" data-intro="Ok, wasn't that fun?" data-position="right">
					<h4>Easy to Use</h4>
			...
			<div class="span4">
				<div data-step="4" data-intro="Get it, use it." data-position="top">
