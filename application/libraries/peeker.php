...
include_once(APPPATH . 'libraries/peeker_connect.php');
...
class peeker extends peeker_connect{
	...
	*/
	public function message($start, $end=NULL)
	{
		...
		include_once(APPPATH . 'libraries/'.$this->message_class.'.php');
	...
	*/
	public function layer($layer)
	{
		...
		include_once(APPPATH . 'libraries/'.$layer_name.'.php');
	...
	*/
	...
	{
		include_once(APPPATH . 'libraries/'.'peeker_detector_set.php');
